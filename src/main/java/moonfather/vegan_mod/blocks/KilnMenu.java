...
public class KilnMenu extends AbstractContainerMenu
{
    ...
    {
        this(VeganMod.Blocks.KILN_MENU_TYPE, containerId, inventory, null, ContainerLevelAccess.NULL, null);
    }
    ...
    {
        this(VeganMod.Blocks.KILN_MENU_TYPE, containerId, inventory, dataAccess, levelAccess, blockContainer);
    }
    public KilnMenu(int containerId, Inventory inv, RegistryFriendlyByteBuf data)
    {
        this(VeganMod.Blocks.KILN_MENU_TYPE, containerId, inv, null, ContainerLevelAccess.NULL, null);
    }
