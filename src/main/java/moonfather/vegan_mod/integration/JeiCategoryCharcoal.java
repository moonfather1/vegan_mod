...
public class JeiCategoryCharcoal extends AbstractRecipeCategory<JeiCategoryCharcoal.CharcoalRecipeForJei>
{
    ...
    {
        super(CHARCOAL_RECIPE_TYPE, VeganMod.Blocks.KILN.get().getName(), guiHelper.createDrawableItemLike(VeganMod.Blocks.KILN_ITEM.get()), 125, 52);
    }
    public static final IRecipeType<CharcoalRecipeForJei> CHARCOAL_RECIPE_TYPE = IRecipeType.create(VeganMod.MODID, "recipe_type2", CharcoalRecipeForJei.class);
